...
class DaysSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('days')->insert([
            ...
            'updated_at' => "2022-03-06 17:00:00",
            'parent_id' => NULL,
            'patient_id' => NULL,
            'category_id' => 2,
            'date' => "2022-04-01",
